        ...
        <section className="bg-white py-10">
          <div className="mx-auto px-10 w-full max-w-[1360px]">
            <div className="max-w-[800px] prose prose-lg">
              ...
              more generally to improve and optimise our Site (for example, by
              ...
              contact us by e-mail at you would like to make a complaint, please
              contact us by e-mail at info@agger-labs.com.
            </div>
          </div>
        </section>
      </div>
